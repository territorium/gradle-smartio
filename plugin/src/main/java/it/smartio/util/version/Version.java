...
public class Version implements Comparable<Version> {
  ...
  /**
   * Creates a new instance of {@link Version} using the provided build number.
   *
   * @param build
   */
  public final Version build(String build) {
    return new Version(getMajor(), getMinor(), getPatch(), getName(), build);
  }
  ...
  /**
   * Creates a new instance of {@link Version} using the provided name of the pre-release.
   *
   * @param name
   */
  public final Version preRelease(String name) {
    return new Version(getMajor(), getMinor(), getPatch(), name, getBuild());
  }
